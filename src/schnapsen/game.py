...
class Hand(CardCollection):
    ...
    def add_DQN(self, card: Card) -> None:
        """
        Add a card to the Hand
...
class GamePlayEngine:
    ...
    def play_game(self, bot1: Bot, bot2: Bot, rng: Random) -> Tuple[Bot, int, Score]:
        ...
        winner, points, score,history = self.play_game_from_state(game_state=game_state, leader_move=None)
        
        return winner, points, score,history
    ...
    def play_action(self, game_state: GameState,action):
        game_over = False
        # do something
    ...
    def play_game_from_state(self, game_state: GameState, leader_move: Optional[Move]) -> Tuple[Bot, int, Score]:
        ...
        return winner.implementation, points, winner.score, LeaderPerspective(game_state, self).get_game_history()
